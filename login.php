...
<form action="api/handler.php" method="post">
    ...
    <div class="container">
        ...
        <div class="btn-group">
            <button type="submit" class="btn btn-primary py-2">Вход</button>
            <button type="button" class="btn btn-outline-dark py-2" onclick="location.href = 'sign-up.php'">Регистрация</button>
        </div>
    </div>
